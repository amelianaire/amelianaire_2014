...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Amelia Johnson - 2012 Holiday Card</title>
    ...
    <article class="content">
        ...
        <div class="row">
            <div class="col span_6 center">
                <h1>Interactive Snowglobe Card</h1>
                <div class="tagline">How do you create a memorable piece for a Texas-based audience? Add longhorns. </div>
            </div>
        </div>
